...
module.exports ={
    ...
    list : async (obj)=>{
        ...
        try{
            ...
            let entity = await mapping.blankCompany();
            return await modelDatabaseLayer.list(entity,obj.filter,obj.value,[appConst.entity.enterprise])
        }
        catch(e){
            throw e;
        }
    ...
    add : async  (obj)=>{
        ...
        try{
            ...
            let entity = await mapping.company(obj)
